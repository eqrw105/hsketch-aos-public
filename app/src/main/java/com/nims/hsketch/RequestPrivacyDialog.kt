...
class RequestPrivacyDialog(context: Context): Dialog(context) {
    ...
    private fun init(){
        ...
        setContentView(R.layout.layout_request_privacy_dialog)     //다이얼로그에 사용할 xml 파일을 불러옴
        setCancelable(false)    //다이얼로그의 바깥 화면을 눌렀을 때 다이얼로그가 닫히지 않도록 함

        //bind
        mRequest_Privacy_Button_OK               = findViewById(R.id.request_privacy_button_ok)
        mRequest_Privacy_Button_Cancel           = findViewById(R.id.request_privacy_button_cancel)
        mRequest_Privacy_Checkbox_Privacy        = findViewById(R.id.request_privacy_checkbox_privacy)
        mRequest_Privacy_Checkbox_Termsofservice = findViewById(R.id.request_privacy_checkbox_termsofservice)
        mRequest_Privacy_Webview                 = findViewById(R.id.request_privacy_webView)
        mRequest_Privacy_Button_Privacy          = findViewById(R.id.request_privacy_button_privacy)
        mRequest_Privacy_Button_Termsofservice   = findViewById(R.id.request_privacy_button_termsofservice)
    }
    ...
    private fun onOkClick(){
        mRequest_Privacy_Button_OK.setOnClickListener {
            ...
            if(!mRequest_Privacy_Checkbox_Privacy.isChecked || !mRequest_Privacy_Checkbox_Termsofservice.isChecked){
                DM.getInstance().showToast(context, context.getString(R.string.request_privacy_notcheck))
