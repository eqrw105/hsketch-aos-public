...
open class SettingItemView : ConstraintLayout {
    ...
    private lateinit var mLayout_Setingitemview_Textview_Title : TextView
    private lateinit var mLayout_Setingitemview_Imageview      : ImageView
    ...
    open fun setDrawable(drawable: Drawable?){
        mLayout_Setingitemview_Imageview.setImageDrawable(drawable)
        onRefresh()
    }
